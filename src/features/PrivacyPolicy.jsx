    ...
    <section>
      ...
      <div className="flex flex-col mt-8 mb-24 space-y-10 text-xl md:mb-12 md:text-left pl-5 pr-5">
        ...
        <div className="mx-auto">
          <h1 className="text-4xl font-bold mb-18">Política de Privacidade</h1>
        </div>
        {/* <!-- Política de Privacidade --> */}
        <div>
          <p className="w-full text-gray-700">
            A sua privacidade é importante para nós. É política do Curso de
            Depilação respeitar a sua privacidade em relação a qualquer
            ...
            , e outros sites que possuímos e operamos. Solicitamos informações
            pessoais apenas quando realmente precisamos delas para lhe fornecer
            ...
            exceto quando exigido por lei. O nosso site pode ter links para
        ...
        {/* <!-- Política de Cookies Curso  --> */}
        <div>
          <h2 className="text-3xl font-semibold">
            Política de Cookies do Curso de Depilação
          </h2>
          {/* <!-- O que são cookies?  --> */}
          <h2 className="text-2xl font-semibold mt-3">O que são cookies?</h2>
          ...
          {/* <!-- Desativar cookies --> */}
          <h2 className="text-2xl font-semibold mt-3">Desativar cookies</h2>
          <p className="w-full text-gray-700 mb-3">
          ...
          {/* <!-- Cookies que defimos --> */}
          <h2 className="text-2xl font-semibold mt-3">Cookies que definimos</h2>
          <ol className="w-full text-gray-700 list-disc pl-8">
        ...
        <div>
          <h2 className="text-2xl font-semibold">Cookies de Terceiros</h2>
        ...
        <div>
          <h2 className="text-2xl font-semibold">Compromisso do Usuário</h2>

          <ol className="w-full text-gray-700 list-disc pl-8">
            <p className="w-full text-gray-700 mb-3">
              O usuário se compromete a fazer uso adequado dos conteúdos e da
              informação que o Curso de Depilação oferece no site e com caráter
            ...
            <li className="ml-8">
              ...
              (softwares) do Curso de Depilação, de seus fornecedores ou
        ...
        {/* <!-- Mais informações --> */}
        <div>
          <h2 className="text-2xl font-semibold">Mais informações</h2>
